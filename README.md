...
Live site: https://zihaowang-kiaa.github.io/personal-homepage/
...
- `Zihao_2026.pdf` - current CV linked from the homepage.

## Notes

The site is static and can be served directly with GitHub Pages. For local preview:
